package ch.codexs.jackson.jsonSchema

import ch.codexs.jackson.jsonSchema.testData.GenericClass.GenericClassVoid
import ch.codexs.jackson.jsonSchema.testData.MapLike.GenericMapLike
import ch.codexs.jackson.jsonSchema.testData.generic.GenericClassContainer
import ch.codexs.jackson.jsonSchema.testData.mixin.{MixinChild1, MixinModule, MixinParent}
import ch.codexs.jackson.jsonSchema.testData.polymorphism1.{Child1, Child2, Parent}
import ch.codexs.jackson.jsonSchema.testData.polymorphism2.{Child21, Child22, Parent2}
import ch.codexs.jackson.jsonSchema.testData.polymorphism3.{Child31, Child32, Parent3}
import ch.codexs.jackson.jsonSchema.testData.polymorphism4.{Child41, Child42}
import ch.codexs.jackson.jsonSchema.testData.polymorphism5.{Child51, Child52, Parent5}
import ch.codexs.jackson.jsonSchema.testData.polymorphism6.{Child61, Parent6}
import ch.codexs.jackson.jsonSchema.testData.polymorphism7.{Child71, Parent7}
import ch.codexs.jackson.jsonSchema.testData._
import ch.codexs.jackson.jsonSchema.testDataScala._
import ch.codexs.jackson.jsonSchema.testData_issue_24.EntityWrapper
...
class JsonSchemaGeneratorTest extends FunSuite with Matchers {
  ...
  test("Generate schema for regular class which has a property of class annotated with @JsonTypeInfo") {
    ...
    //Using fully-qualified class names
    {
      ...
      assertChild1(schema, "/properties/child/oneOf", "ch.codexs.jackson.jsonSchema.testData.polymorphism1.Child1")
      assertChild2(schema, "/properties/child/oneOf", "ch.codexs.jackson.jsonSchema.testData.polymorphism1.Child2")
    }
    ...
    // Using fully-qualified class names and nullable types
    {
      ...
      assertNullableChild1(schema, "/properties/child/oneOf/1/oneOf", "ch.codexs.jackson.jsonSchema.testData.polymorphism1.Child1")
      assertNullableChild2(schema, "/properties/child/oneOf/1/oneOf", "ch.codexs.jackson.jsonSchema.testData.polymorphism1.Child2")
    }
  ...
  test("Generate schema for super class annotated with @JsonTypeInfo - use = JsonTypeInfo.Id.CLASS") {
    ...
    // Java
    {
      ...
      assertChild1(schema, "/oneOf", "Child21", typeParamName = "clazz", typeName = "ch.codexs.jackson.jsonSchema.testData.polymorphism2.Child21")
      assertChild2(schema, "/oneOf", "Child22", typeParamName = "clazz", typeName = "ch.codexs.jackson.jsonSchema.testData.polymorphism2.Child22")
    }
  }
